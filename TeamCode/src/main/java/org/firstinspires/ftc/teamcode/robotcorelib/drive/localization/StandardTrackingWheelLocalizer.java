...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer implements Localizer {
    ...
    public static double LATERAL_DISTANCE_OFFSET = 0.0682911414; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -5.978; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;

    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        super(Arrays.asList(
                new Pose2d(-2.164, 4.39 + LATERAL_DISTANCE_OFFSET, 0), // left
                new Pose2d(-2.164, -(4.205 + LATERAL_DISTANCE_OFFSET), 0), // right
